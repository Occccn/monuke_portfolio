export const videos = [
  {
    url: "https://www.youtube.com/embed/BEnAaW3EtTk?si=8dlD8U3tek-jVH6a",
    title: "降降 feat.ずんだもん【VoiSona self cover】",
    description: "物語性のある歌詞を書こうと思い、...",
    date: "2024/07/07",
    credit: "動画素材：カナダリス様、@waka様、フリー素材あそび様",
    feat: "zunda",
  ...
  },
  {
    ...
    },
    {
        ...
        date: "2023/12/16",
        credit: "ギター：花城伸昌（ASTLIGHT）様 ／ イラスト：Lah様",
        feat: "chisei",
    ...
    },
    {
      ...
      },
      {
        ...
        date: "2022/10/10",
        credit: "イラスト：eruri様 ／ 背景画像：野田工房P様",
        feat: "hatune",
